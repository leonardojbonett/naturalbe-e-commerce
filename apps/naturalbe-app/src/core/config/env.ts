...
const envSchema = z.object({
  ...
  VITE_APP_RELEASE: z.string().default("dev-local"),
  VITE_SITE_ORIGIN: z.string().url().default("https://naturalbe.com.co"),
  ...
  VITE_ORDER_API_PATH: z.string().default("/api/orders"),
  VITE_METRICS_PATH: z.string().default("/api/metrics"),
  ...
  VITE_ALLOW_MOCK_CATALOG_FALLBACK: z.enum(["true", "false"]).optional()
});
...
export const appEnv = {
  ...
  appRelease: parsed.data.VITE_APP_RELEASE,
  siteOrigin: parsed.data.VITE_SITE_ORIGIN,
  apiBaseUrl: parsed.data.VITE_API_BASE_URL,
  waNumber: parsed.data.VITE_WA_NUMBER,
  productsPath: parsed.data.VITE_PRODUCTS_PATH,
  orderApiPath: parsed.data.VITE_ORDER_API_PATH,
  metricsPath: parsed.data.VITE_METRICS_PATH,
  ...
  allowMockCatalogFallback:
    parsed.data.VITE_ALLOW_MOCK_CATALOG_FALLBACK !== undefined
      ? parsed.data.VITE_ALLOW_MOCK_CATALOG_FALLBACK === "true"
