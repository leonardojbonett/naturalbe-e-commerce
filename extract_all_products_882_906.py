#!/usr/bin/env python3
"""
Extract all product improvements from docx_structured_882_906.json
for IDs 882-906
"""
...
with open('docx_structured_882_906.json', 'r', encoding='utf-8') as f:
...
for table_idx, table in enumerate(docx_data['table_data'][1:], start=882):
...
# Save to JSON
with open('all_products_mapping_882_906.json', 'w', encoding='utf-8') as f:
    json.dump(all_products, f, ensure_ascii=False, indent=2)

print(f"Extracted data for {len(all_products)} products (882-906)")
