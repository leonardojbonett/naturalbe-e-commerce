...
function showCustomerFormWompi() {
        ...
        <div class="wompi-form-wrap">
            ...
            <form id="wompiCustomerForm">
                ...
                <div class="wompi-field">
                    ...
                    <select id="wompiCustomerCity" required
                            class="wompi-select">
                ...
                <div class="wompi-actions">
                    ...
                    <button type="button" id="wompiBackToCatalogBtn" class="wompi-secondary-btn">
                        Volver al catálogo
                    </button>
                </div>
            </form>
    ...
    `;
    const form = document.getElementById('wompiCustomerForm');
    if (form) {
        form.addEventListener('submit', processWompiPayment);
    }
    const citySelect = document.getElementById('wompiCustomerCity');
    if (citySelect) {
        citySelect.addEventListener('change', calculateShippingWompi);
    }
    const backBtn = document.getElementById('wompiBackToCatalogBtn');
    if (backBtn) {
        backBtn.addEventListener('click', goBackFromWompiCheckout);
    }
