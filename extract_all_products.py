#!/usr/bin/env python3
"""
Extract all product improvements from docx_structured.json
and generate complete mapping
"""
...
for table_idx, table in enumerate(docx_data['table_data'][1:], start=824):
...
# Save to JSON
with open('all_products_mapping.json', 'w', encoding='utf-8') as f:
