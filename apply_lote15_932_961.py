#!/usr/bin/env python3
"""
Apply SEO improvements from productos_corregidos_lote15_IDs932-961.json
"""
...
# Load JSON data
with open('productos_corregidos_lote15_IDs932-961.json', 'r', encoding='utf-8') as f:
    products = json.load(f)

producto_path = Path('./producto')

print(f"Processing {len(products)} products from JSON (IDs 932-961)...\n")
