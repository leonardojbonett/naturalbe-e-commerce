...
const STATIC_URLS = [
  ...
  { loc: '/objetivo-estres.html', changefreq: 'weekly', priority: '0.8' },
  { loc: '/objetivo-inmunidad.html', changefreq: 'weekly', priority: '0.8' },
  { loc: '/objetivo-piel.html', changefreq: 'weekly', priority: '0.8' },
  { loc: '/objetivo-energia.html', changefreq: 'weekly', priority: '0.8' },
